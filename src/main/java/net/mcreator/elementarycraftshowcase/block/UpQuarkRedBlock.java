...
public class UpQuarkRedBlock extends ElementaryCraftShowcaseModElements.ModElement {
	@ObjectHolder("elementary_craft_showcase:up_quark_red")
	public static final Block block = null;
	public UpQuarkRedBlock(ElementaryCraftShowcaseModElements instance) {
		super(instance, 4);
	}
