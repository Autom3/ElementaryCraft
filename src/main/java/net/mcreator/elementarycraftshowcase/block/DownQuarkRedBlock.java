...
public class DownQuarkRedBlock extends ElementaryCraftShowcaseModElements.ModElement {
	@ObjectHolder("elementary_craft_showcase:down_quark_red")
	public static final Block block = null;
	public DownQuarkRedBlock(ElementaryCraftShowcaseModElements instance) {
		super(instance, 5);
	}
