...
public class HydrogenBlock extends ElementaryCraftShowcaseModElements.ModElement {
	@ObjectHolder("elementary_craft_showcase:hydrogen")
	public static final Block block = null;
	public HydrogenBlock(ElementaryCraftShowcaseModElements instance) {
		super(instance, 18);
	}
