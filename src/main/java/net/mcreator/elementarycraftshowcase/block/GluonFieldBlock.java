...
import net.mcreator.elementarycraftshowcase.procedures.GluonFieldDropProcedure;
...
public class GluonFieldBlock extends ElementaryCraftShowcaseModElements.ModElement {
	@ObjectHolder("elementary_craft_showcase:gluon_field")
	public static final Block block = null;
	public GluonFieldBlock(ElementaryCraftShowcaseModElements instance) {
		super(instance, 1);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				GluonFieldDropProcedure.executeProcedure($_dependencies);
			}
