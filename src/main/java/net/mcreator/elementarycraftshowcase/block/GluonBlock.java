...
public class GluonBlock extends ElementaryCraftShowcaseModElements.ModElement {
	@ObjectHolder("elementary_craft_showcase:gluon")
	public static final Block block = null;
	public GluonBlock(ElementaryCraftShowcaseModElements instance) {
		super(instance, 2);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Holds quarks together"));
		}
