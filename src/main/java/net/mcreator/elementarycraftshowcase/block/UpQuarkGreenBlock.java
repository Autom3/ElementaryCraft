...
public class UpQuarkGreenBlock extends ElementaryCraftShowcaseModElements.ModElement {
	@ObjectHolder("elementary_craft_showcase:up_quark_green")
	public static final Block block = null;
	public UpQuarkGreenBlock(ElementaryCraftShowcaseModElements instance) {
		super(instance, 11);
	}
