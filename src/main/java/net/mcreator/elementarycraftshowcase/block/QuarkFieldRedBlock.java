...
import net.mcreator.elementarycraftshowcase.procedures.QuarkFieldRedDropProcedure;
...
public class QuarkFieldRedBlock extends ElementaryCraftShowcaseModElements.ModElement {
	@ObjectHolder("elementary_craft_showcase:quark_field_red")
	public static final Block block = null;
	public QuarkFieldRedBlock(ElementaryCraftShowcaseModElements instance) {
		super(instance, 3);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("quark_field_red");
		}
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				QuarkFieldRedDropProcedure.executeProcedure($_dependencies);
			}
