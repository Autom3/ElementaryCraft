...
import net.mcreator.elementarycraftshowcase.procedures.QuarkFieldBlueDropProcedure;
...
public class QuarkFieldBlueBlock extends ElementaryCraftShowcaseModElements.ModElement {
	@ObjectHolder("elementary_craft_showcase:quark_field_blue")
	public static final Block block = null;
	public QuarkFieldBlueBlock(ElementaryCraftShowcaseModElements instance) {
		super(instance, 6);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("quark_field_blue");
		}
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				QuarkFieldBlueDropProcedure.executeProcedure($_dependencies);
			}
