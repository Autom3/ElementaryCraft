...
import net.mcreator.elementarycraftshowcase.procedures.QuarkFieldGreenDropProcedure;
...
public class QuarkFieldGreenBlock extends ElementaryCraftShowcaseModElements.ModElement {
	@ObjectHolder("elementary_craft_showcase:quark_field_green")
	public static final Block block = null;
	public QuarkFieldGreenBlock(ElementaryCraftShowcaseModElements instance) {
		super(instance, 23);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("quark_field_green");
		}
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				QuarkFieldGreenDropProcedure.executeProcedure($_dependencies);
			}
