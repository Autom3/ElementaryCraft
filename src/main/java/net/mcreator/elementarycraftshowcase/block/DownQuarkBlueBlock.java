...
public class DownQuarkBlueBlock extends ElementaryCraftShowcaseModElements.ModElement {
	@ObjectHolder("elementary_craft_showcase:down_quark_blue")
	public static final Block block = null;
	public DownQuarkBlueBlock(ElementaryCraftShowcaseModElements instance) {
		super(instance, 8);
	}
