...
import net.mcreator.elementarycraftshowcase.procedures.EMFieldDropProcedure;
...
public class EMFieldBlock extends ElementaryCraftShowcaseModElements.ModElement {
	@ObjectHolder("elementary_craft_showcase:em_field")
	public static final Block block = null;
	public EMFieldBlock(ElementaryCraftShowcaseModElements instance) {
		super(instance, 14);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				EMFieldDropProcedure.executeProcedure($_dependencies);
			}
